Vagrant.configure("2") do |config|
  config.vm.box = "c7nmp_updated_v0.16.1"
  config.vm.box_url = "https://s3.eu-central-1.amazonaws.com/vm-box-storage/c7nmp_updated_v0.16.1.box"
  ...
  config.vm.provision "shell", inline: "mkdir -p /home/vagrant/bin && curl -f -o /home/vagrant/bin/aiqa https://vm-box-storage.s3.eu-central-1.amazonaws.com/aiqa && chmod u+x /home/vagrant/bin/aiqa && chown vagrant:vagrant /home/vagrant/bin/aiqa", run: "always"
end
